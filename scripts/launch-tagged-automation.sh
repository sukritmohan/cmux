...
APP="$HOME/Library/Developer/Xcode/DerivedData/cmux-${TAG_SLUG}/Build/Products/Debug/Beethoven DEV ${TAG}.app"
...
sleep 0.5
pkill -f "Beethoven DEV ${TAG}.app/Contents/MacOS/Beethoven DEV" || true
rm -f "$SOCK" "$DSOCK"
sleep 0.5
