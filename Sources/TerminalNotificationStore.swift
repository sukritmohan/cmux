...
final class TerminalNotificationStore: ObservableObject {
    ...
    private func presentNotificationSettingsPrompt(attempt: Int) {
        ...
        alert.messageText = String(localized: "dialog.enableNotifications.title", defaultValue: "Enable Notifications for Beethoven")
        alert.informativeText = String(localized: "dialog.enableNotifications.message", defaultValue: "Notifications are disabled for Beethoven. Enable them in System Settings to see alerts.")
